...
public class DownloadTask {
    ...
    public DownloadTask(Context context,String name, String downloadUrl) {
    ...
    private class DownloadingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                File fileStorage = new File(Environment.getExternalStorageDirectory()+ "/", context.getString(R.string.app_name)+"/stages");
